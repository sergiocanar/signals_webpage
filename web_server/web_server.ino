...
void loop() {
  ...
  client.print("    margin: auto;");
  client.print("}");
  client.print("");
  client.print("#more-info-button:hover {");
  ...
  client.print("                    <button id='more-info-button' class='btn btn-primary'>Conocer m√°s sobre mi estado</button>");
  client.print("                    <div style='height: 50px;'></div>");
  client.print("                </div>");
  client.print("            </div>");
  client.print("        </div>");
  client.print("        ");
  ...
  client.print("    let moreInfoButton = document.getElementById('more-info-button');");
  ...
  client.print("        ");
  client.print("        moreInfoButton.style.display = 'block'; ");
  client.print("");
  client.print("        if (bpm < 60) {");
  client.print("            alertView.innerText = 'Alert! possible bradycardia.';");
  client.print("            alertView.style.color = 'red';");
  client.print("            moreInfoButton.onclick = () => {");
  client.print("                alert('La bradicardia es una condiciÛn en la que el corazÛn late m·s despacio de lo normal. Puede ser grave en algunos casos y requerir tratamiento.\n' + '\n' + ");
  client.print("                      'Bradicardia leve: 50-60 bpm.\n' +'\n' + ");
  client.print("                      'Bradicardia moderada: 40-50 bpm.\n' +'\n' + ");
  client.print("                      'Bradicardia severa: Menos de 40 bpm.');");
  client.print("            };");
  client.print("        } else if (bpm > 100) {");
  client.print("            alertView.innerText = 'Alert! possible tachycardia.';");
  client.print("            alertView.style.color = 'red';");
  client.print("            moreInfoButton.onclick = () => {");
  client.print("                alert('La taquicardia es una condiciÛn en la que el corazÛn late m·s r·pido de lo normal. Es importante controlarla, ya que puede derivar en problemas m·s serios.\n' + '\n' + ");
  client.print("                      'Taquicardia leve: 100-120 bpm.\n' + '\n' + ");
  client.print("                      'Taquicardia moderada: 120-150 bpm.\n' + '\n' + ");
  client.print("                      'Taquicardia grave: M·s de 150 bpm.');");
  client.print("            };");
  client.print("        } else {");
  client.print("            alertView.innerText = 'Within the normal range.';");
  client.print("            alertView.style.color = 'green';");
  client.print("            moreInfoButton.onclick = () => {");
  client.print("                alert('Tu frecuencia cardÌaca est· dentro de los niveles normales. °Sigue asÌ!');");
  client.print("            };");
  client.print("        }");
  client.print("    } else {");
  ...
  client.print("        moreInfoButton.style.display = 'none'; ");
  client.print("    }");
  client.print("}");
  client.print("");
  client.print("");
