      ...
      <div class='row'>
          ...
          <div class='col-4'>
              <button class='btn btn-primary' onclick='showPopup()'>
                  ...
                  <span style='display: block; text-indent: 20px;'>Intelligent monitoring for evolving athletes.</span>
              </button>
          </div>
          <div id='popup' class='popup'>
              <div class='popup-content'>
                  ...
                  <p>High-performance sports practice has been associated in recent years with cardiomyopathies,
                      ...
                      electrolyte imbalances, physiological stress, and muscle fatigue increase athletes' susceptibility
                      ...
                      The project has been driven by several notable incidents in the sports field that have highlighted
                  ...
                  <figure style='position: relative; align-items: center; margin: 0 auto;'>
                      <img class='img-fluid' src='https://i.ibb.co/FqC88ZV/Imagen-inv.png'
                          style='width: 70%; '>
                  </figure>
                  ...
                  <p>Regarding statistical data, cardiac arrhythmia has a global prevalence of 1.5% to 5%,
                      ...
                      ventricular arrhythmias during the race [10]. These scenarios highlight the health and life risks
                  ...
                  <figure style='position: relative; align-items: center; margin: 0 auto;'>
                      <img class='img-fluid' src='https://drive.google.com/thumbnail?id=1ezARWMQk74BPl_LAeOS_xsfKKdh7ba7C'
                          style='width: 30%; '>
                  </figure>
...
const DATA_COLLECTION_TIME_MS = 500; 
const SAMPLE_PERIOD_MS = 5; 
const SAMPLE_RATE_HZ = Math.round(1 / (SAMPLE_PERIOD_MS / 1000)); 
...
function detectPeaksWithSlidingWindow(signal) {
    ...
    let windowSize = 10 * SAMPLE_RATE_HZ; 
