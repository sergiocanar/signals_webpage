...
void loop() {
  ...
  client.println("                    <img class='img-fluid' src='https://drive.google.com/thumbnail?id=1R8gDDiJrOu39KTVjqC5HQDitdLBYhqvo' ");
  client.println("                        style='width: 50%; margin-bottom: 3%;'>");
  client.println("                </figure>");
  client.println("            </div>");
  client.println("            <div class='col-4'>");
  client.println("                <button class='btn btn-primary' onclick='showPopup()'>");
  client.println("                    Discover more about CardioHub!<br>");
  client.println("                    <span style='display: block; text-indent: 20px;'>Intelligent monitoring for evolving athletes.</span>");
  ...
  client.println("                    <h2>CardioHub: Intelligent Monitoring for Evolving Athletes.</h2>");
  client.println("                    <figure style='position: relative; align-items: center; margin: 0 auto;'>");
  client.println("                        <img class='img-fluid' src='https://drive.google.com/thumbnail?id=1R8gDDiJrOu39KTVjqC5HQDitdLBYhqvo'");
  client.println("                            style='width: 10%; '>");
  client.println("                    </figure>");
  client.println("                    <h4>About arrhythmias and the current issue: </h4>");
  client.println("                    <p>High-performance sports practice has been associated in recent years with cardiomyopathies,");
  client.println("                        ventricular arrhythmias, and coronary diseases, highlighting the importance of constant");
  client.println("                        monitoring both during exercise and in the recovery phase [1]. Factors such as dehydration,");
  client.println("                        electrolyte imbalances, physiological stress, and muscle fatigue increase athletes' susceptibility");
  client.println("                        to heart problems, raising the risk of sudden cardiac death (SCD), particularly in those with");
  client.println("                        undiagnosed underlying conditions, such as hypertrophic cardiomyopathy [2]. Additionally,");
  client.println("                        the incidence of SCD is higher during or immediately after exercise, reinforcing the need for");
  client.println("                        technological solutions to monitor real-time cardiac activity, alerting athletes and coaches");
  client.println("                        about potential life-threatening abnormalities [3]. Among the existing options for continuous");
  client.println("                        monitoring, the use of electrocardiograms (ECG) is essential, as it allows measuring the heart's");
  client.println("                        electrical activity and detecting arrhythmias and conduction abnormalities [4].");
  client.println("                        The project has been driven by several notable incidents in the sports field that have highlighted");
  client.println("                        the urgent need to improve cardiac monitoring tools for athletes. One of the most recent and");
  client.println("                        recognized cases is that of footballer Sergio Agüero, who suffered an arrhythmia during a match");
  client.println("                        in 2021, forcing him to retire from professional football. This case not only demonstrated the");
  client.println("                        possible consequences of an undiagnosed arrhythmia in time but also revealed the need for more");
  client.println("                        rigorous monitoring during sports activity. Another example is the Uruguayan football player");
  client.println("                        Juan Izquierdo, who died due to a cardiorespiratory arrest related to an arrhythmia while");
  client.println("                        training [5]. The circumstances and issues of cardiac monitoring extend to other sports");
  client.println("                        disciplines, such as the case of South African triathlete Richard Murray, who was diagnosed");
  client.println("                        with atrial fibrillation in 2021, limiting his performance in this discipline. Since then, he");
  client.println("                        has had to adapt his training and lifestyle to manage the condition [6].");
  client.println("                    </p>");
  client.println("                    <figure style='position: relative; align-items: center; margin: 0 auto;'>");
  client.println("                        <img class='img-fluid' src='https://i.ibb.co/FqC88ZV/Imagen-inv.png'");
  client.println("                            style='width: 70%; '>");
  client.println("                    </figure>");
  client.println("                    <h4>Statistical data on arrhythmias, a common problem in high-performance athletes: </h4>");
  client.println("                    <p>Regarding statistical data, cardiac arrhythmia has a global prevalence of 1.5% to 5%,");
  client.println("                        with atrial fibrillation (AF) being its most common form [7]. In Colombia, it is estimated that");
  client.println("                        between 2013 and 2017, 87 out of every 100,000 inhabitants suffered from AF, with this value");
  client.println("                        increasing to 150 in central regions of the country [8]. Concerning athletes, it is estimated");
  client.println("                        that 1 in every 59,452 athletes suffers a cardiac arrest associated with a cardiac arrhythmia,");
  client.println("                        representing 1.7 cases per 100,000 athletes [9]. Epidemiological statistics have also revealed");
  client.println("                        the extent of the problem. Recent research has shown that 12.9% of marathon runners experienced");
  client.println("                        ventricular arrhythmias during the race [10]. These scenarios highlight the health and life risks");
  client.println("                        athletes may face, raising questions about the current capability of monitoring devices to");
  client.println("                        detect arrhythmias promptly during intense exercise.");
  client.println("                    </p>");
  client.println("                    <h4>Main causes contributing to the development of pathophysiology: </h4>");
  client.println("                    <ol>");
  client.println("                        <li>Sports supplements</li>");
  client.println("                        <p>The use of sports supplements, especially anabolic steroids, is associated with a higher");
  client.println("                            risk of AF in young athletes. These products can alter normal cardiac mechanisms,");
  client.println("                            predisposing to the development of arrhythmias [11] </p>");
  client.println("                        <li>Atrial ectopy</li>");
  client.println("                        <p>AF in athletes can also be triggered by focal ectopic discharges in the pulmonary veins.");
  client.println("                            These discharges result from increased sympathetic activity due to intense exercise,");
  client.println("                            which can alter the normal heart rhythm [11]</p>");
  client.println("                        <li>Inflammation and fibrosis</li>");
  client.println("                        <p>Excessive exercise and intense training can cause chronic systemic inflammation,");
  client.println("                            manifested in elevated levels of C-reactive protein. This inflammatory process, along with");
  client.println("                            the development of fibrosis in cardiac tissue, creates a conducive environment for the");
  client.println("                            occurrence of AF, as it alters the heart's normal structure and function [11]</p>");
  client.println("                        <li>Electrolyte imbalance</li>");
  client.println("                        <p>High-intensity training can cause significant changes in the body's fluid dynamics,");
  client.println("                            leading to electrolyte imbalances. These imbalances, such as extreme dehydration, can");
  client.println("                            alter cardiac function and favor the development of AF in athletes [11].</p>");
  client.println("                    </ol>");
  client.println("                    <h4>CardioHub as a wearable, its relevance for monitoring arrhythmias in athletes: </h4>");
  client.println("                    <p>The use of a wearable device like CardioHub to monitor real-time electrical activity of the heart");
  client.println("                        is crucial to prevent serious complications in athletes. These devices allow early detection");
  client.println("                        of arrhythmias and provide accurate information about cardiac status during intense exercise");
  client.println("                        and recovery, helping to prevent sudden cardiac death (SCD). By providing real-time alerts");
  client.println("                        about cardiac irregularities, these wearables enable coaches and doctors to make quick decisions");
  client.println("                        and prevent undiagnosed conditions from progressing to critical situations [12]. Additionally,");
  client.println("                        continuous monitoring helps adjust athletes' training routines to optimize their health and");
  client.println("                        performance without compromising their cardiac well-being [13].");
  client.println("                    </p>");
  client.println("                    <p");
  client.println("                        style='font-size: 20px; text-align: center; font-style: italic; font-weight: 550; color: #316bd6;'>");
  client.println("                        CardioHub provides an innovative solution to safeguard athletes' health while they strive to");
  client.println("                        reach their peak performance. The key lies in prevention, and continuous monitoring is the tool");
  client.println("                        that ensures athletes' hearts keep beating safely and strongly.</p>");
  client.println("");
  client.println("                    <figure style='position: relative; align-items: center; margin: 0 auto;'>");
  client.println("                        <img class='img-fluid' src='https://drive.google.com/thumbnail?id=1ezARWMQk74BPl_LAeOS_xsfKKdh7ba7C'");
  client.println("                            style='width: 30%; '>");
  client.println("                    </figure>");
  client.println("");
  client.println("                    <h4>References</h4>");
